...
from dl_01.dl_01_04.testCases_v2 import *
from dl_01.dl_01_04.dnn_utils_v2 import sigmoid, sigmoid_backward, relu, relu_backward
...
def initialize_parameters_deep_test():
    """
    initialize_parameters_deep 测试
    :return:
    """
    parameters = initialize_parameters_deep([5, 4, 3])
    for key in parameters:
        print(f"{key} = {str(parameters[key])}")
